...
def index():
    while True:
        try:
            current_url = r'/home/pi/Documents/weather/current.json'
            with open(current_url) as current:
                current_data = json.load(current)
            forecast_url = r'/home/pi/Documents/weather/forecast.json'
            with open(forecast_url) as forecast:
                forecast_data = json.load(forecast)
            inside_url = r'/home/pi/Documents/weather/inside.json'
            with open(inside_url) as inside:
                inside_data = json.load(inside)
            alerts_url = r'/home/pi/Documents/weather/alerts.json'
